...
dependencies:
  '@astrojs/node': 5.0.3_astro@2.0.14
  astro: 2.0.14
...
packages:
  ...
  /@astrojs/markdown-remark/2.0.1_astro@2.0.14:
  ...
  /@astrojs/node/5.0.3_astro@2.0.14:
    resolution: {integrity: sha512-zjyTE7ZWkwmJGbg1r7lOQJqRREqDV+yu2Qb4VTiJ8zek9ts4JD3syKRXXJxf9W2lhtIOMbukDmupIa+0Hkxq/w==}
    peerDependencies:
      astro: ^2.0.6
    dependencies:
  ...
  /@astrojs/webapi/2.0.1:
    resolution: {integrity: sha512-aOOHa86W5Ux77A3dS91YrVlSxtBSJsVK4UhvcXHY0gAl0ZrOStSKSBO45gZ6tFi2AiHu3bzpMtZjwrPHtl+cyg==}
    dependencies:
      undici: 5.18.0
    dev: false
